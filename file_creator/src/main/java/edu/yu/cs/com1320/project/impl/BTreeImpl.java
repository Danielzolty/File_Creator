...
public class BTreeImpl<Key extends Comparable<Key>, Value> implements BTree<Key, Value> {
    ...
    //This is to convert a File into a Document so that it could be returned to DocStore
    ...
    public Value get(Key k) {
        ...
        if(entry != null)
        {
            if (entry.val ==null){
                try {
                    Value temp = this.persistenceManager.deserialize((k));
                    entry.val = temp;
                } catch (IOException e) {
                    e.printStackTrace();
                }
    ...
    public Value put(Key k, Value v) {
        ...
        Entry alreadyThere = this.get(this.root, (Key) k, this.height);
        Value value = this.get(k);
        //System.out.println("This is the alreadyThere entry:  " + alreadyThere);
        ...
        if (newNode == null)
        {
            return null; //Return null when there is nothing being replaced
        }
        ...
        this.height++;
        return null; // there is no previous value to return
    }
    ...
    private Node put(Node currentNode, Key key, Value val, int height)
    {
        ...
        {
            // Only keys which are less than should be shifted over
    ...
    private Node split(Node currentNode, int height)
    {
        ...
        //Making a linked list between the nodes.
        if (height == 0)
        {
